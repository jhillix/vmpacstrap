# -*- coding: utf-8 -*-
#
# vmpacstrap documentation build configuration file
#
...
latex_documents = [
    ('index', 'vmpacstrap.tex', u'VMPacstrap Documentation',
...
man_pages = [
    ('overview', 'vmpacstrap', u'install basic Arch system into virtual disk image',
     [u'Neil Williams'], 8),
]
